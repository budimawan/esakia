...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url('Auth');?>" class="nav-link active">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021-2022 <a href="#">DINAS PERDAGANGAN DAN PERINDUSTRIAN DAERAH KABUPATEN MOROWALI</a>.</strong>
    All rights reserved.
